define(function(require) {
	return {
		api: {
			...
			default: 'https://sandbox.2600hz.com:8443/v2/', // if you don't set this value, Monster will automatically use your current hostname + ':8000/v2' as the default API URL.
