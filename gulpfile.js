...
function serveDev(done) {
	...
	gulp.watch(paths.src + '/**/*.scss', gulp.series(watchScss));
	gulp.watch(paths.src + '/**/*.css', gulp.series(watchCss));
	gulp.watch(paths.src + '/**/*.html', gulp.series(watchHtml));
	gulp.watch(paths.src + '/**/*.js', gulp.series(watchJs));
	gulp.watch(paths.src + '/**/*.json', gulp.series(watchJson));
...
gulp.task('serve', gulp.series('build-dev', serveDev));
gulp.task('serve-prod', gulp.series('build-prod', serveProd));
