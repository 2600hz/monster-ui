( function(winkstart, amplify, $) {
    ...
    winkstart.confirm = function(content, callback_ok, callback_cancel) {
        ...
        html = $('<div class="alert-dialog"><div class="help-box gray-box"><div class="icon-wrapper"><i class="icon-question-sign2"></i></div><div class="text-wrapper">'+content+'</div></div><div class="alert-buttons-wrapper"><button id="cancel_button" class="btn btn-danger confirm_button">Cancel</button><button id="confirm_button" class="btn btn-success confirm_button">OK</button></div></div>');
    ...
    winkstart.alert = function(type, content, callback) {
        ...
        if(type_temp == 'error') {
            html = $('<div class="alert-dialog"><div class="help-box red-box"><div class="icon-wrapper"><i class="icon-remove icon-red"></i></div><div class="text-wrapper">'+content+'</div></div></div>');

            if(content && content.data) {
                html = $('<div class="center"><div class="alert_img error_alert"></div><div class="alert_text_wrapper error_alert"><span><p>' +
                    content.text +
                    '<p>' +
                    '<p><button class="btn small btn-danger json">Show Errors</button>' +
                    '</p><p style="display:none" class="json_error"></p>' +
                    '</span></div><div class="clear"/></div>');
            }
        }
        else if(type_temp == 'info'){
            html = $('<div class="alert-dialog"><div class="help-box gray-box"><div class="icon-wrapper"><i class="icon-info-sign2 icon-blue"></i></div><div class="text-wrapper">'+content+'</div></div></div>');

        //html = $('<div class="center"><div class="alert_img info_alert"></div><div class="alert_text_wrapper info_alert"><span>' + content + '</span></div><div class="clear"/><div class="alert_buttons_wrapper"><button class="btn btn-primary alert_button">Close</button></div></div>');
        }
        else {
            callback = content;
            content = type;
            ...
            html = $('<div class="alert-dialog"><div class="help-box red-box"><div class="icon-wrapper"><i class="icon-remove icon-red"></i></div><div class="text-wrapper">'+content+'</div></div></div>');
            //html = $('<div class="alert-dialog"><div class="help-box orange-box"><div class="icon-wrapper"><i class="icon-warning-sign2 icon-orange"></i></div><div class="text-wrapper">'+content+'</div></div></div>');
        }
