...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+sSpace+'<span class="search-box pull-right"><i class="icon-search"></i><input type="text" placeholder="'+i18n.t('core.layout.search')+'..." class="search-query"></span>;';
